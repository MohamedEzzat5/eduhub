...
class _DoctorCurrentSubjectState extends State<DoctorCurrentSubject> with TickerProviderStateMixin {
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: CustomMaterialButton(onPressed: (){
                                  GoRouter.of(context) .push(AppRouter.doctorAddLecScreen);
                          ...
                          Column(
                            children: [
                              ...
                              Padding(
                                ...
                                EdgeInsets.all(12.r),
                                child: CustomMaterialButton(onPressed: (){
                                  GoRouter.of(context) .push(AppRouter.doctorAddSheetScreen);
                                },
                                  text: 'اضافة تكليف',
                                  width:  context.width*0.4,
                                  radius: 5,
